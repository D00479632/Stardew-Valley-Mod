...
Green Bean 2 Spring 10 Days Grows on Trellis. Continues to produce every 3 days. Bean Hotpot (2)
...
Image Name Amount needed Ingredients Required for Fried Egg 1 Egg (1) Complete Breakfast (1) Hashbrowns 2 Potato (1) Oil (1) Complete Breakfast (1) Dish O' The Sea (1) Pancakes 1 Wheat Flour (1) Egg (1) Complete Breakfast (1) Tortilla 2 Corn (1) Fish Taco (1) Lucky Lunch (1) Bread 3 Wheat Flour (1) Bruschetta (1) Stuffing (1) Survival Burger (1) Omelet 1 Egg (1) Milk (1) Farmer's Lunch (1)
...
- Algae Soup
- Bean Hotpot
- Blackberry Cobbler (either without Bear's Knowledge or using Wheat Flour and/or Sugar from the Mill)
- Bread (if made with Wheat Flour from the Mill)
- Carp Surprise (though Sashimi is more profitable)
- Chocolate Cake (if using Wheat Flour and Sugar from the Mill)
- Eggplant Parmesan
- Fiddlehead Risotto (if made with homemade Oil)
- Fruit Salad
- Lucky Lunch
- Maki Roll (if using Rice from the Mill and fish worth less than data-sort-value="100"&gt;100g)
- Pale Broth
- Pink Cake (if using Wheat Flour and Sugar from the Mill)
- Poppyseed Muffin (if using Wheat Flour and Sugar from the Mill)
- Radish Salad (if using Rice from the Mill and Vinegar from a keg)
- Red Plate
- Rhubarb Pie (if using Wheat Flour and Sugar from the Mill)
- Roots Platter
- Spaghetti (if made with Wheat Flour from the Mill)
- Spicy Eel
- Stir Fry (if made with homemade Oil)
- Survival Burger (if using Bread made with Wheat Flour from the Mill)
- Tom Kha Soup
- Tropical Curry
- Trout Soup (without the Angler Profession)

<!--THE END-->

- Sashimi, when cooked with any fish worth less than data-sort-value="75"&gt;75g:
