...
Stardew Valley 1.6.13 was released on 08 November 2024.
...
1.3.35 beta (2 February 2019, didn't change version)

- Added Hungarian language.
- Improved Korean font.

1.3.35 beta (24 January 2019)
...
**Beta Versions (1.3.0–1.3.27)**  The above list shows changes compared to the previous 1.2.33 stable release. Here are the changes in individual beta builds:
...
- Fixed startup\_preferences permission crash.
...
**Beta Versions (1.2.0–1.2.25)**  The above list shows changes compared to the previous 1.11 stable release. Here are the changes in individual beta builds:
...
- Fixed broken macOS app directory structure causing crashes on launch
...
- Translations for German, Spanish, Brazilian Portuguese, Russian, Japanese and Simplified Chinese (and official wiki support for these languages)
- Exit to Title has returned
...
Retrieved from "https://stardewvalleywiki.com/mediawiki/index.php?title=Version\_History&amp;oldid=182831"
